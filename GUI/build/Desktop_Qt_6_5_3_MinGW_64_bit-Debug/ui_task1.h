...
public:
    ...
    void setupUi(QWidget *Task1)
    {
        ...
        gridLayout->addWidget(lineEdit2_Task3, 2, 1, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_Task3, 2, 2, 1, 3);
